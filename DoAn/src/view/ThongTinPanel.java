...
public class ThongTinPanel extends JPanel{
    public ThongTinPanel(){
        ...
        String[][] values = new String[][]{
            {"Đồ Án","CỜ VUA MINIMAX CẮT TỈA "+DuLieuCoVua.VERSION},
            
            {"Author","Văn Tiến"},
            {"Mọi thắc mắc xin liên hệ ","https://www.facebook.com/vantien"},
            {"Số điện thoại ","0963784807"},
            {"Hướng Dẫn cách chơi  ","http://www.hoccovua.com"},
            {"Phiên bản V1 khởi tạo ngày ","1/11/2022"}
        };
